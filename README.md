...
- It supports lengthy equations as long as they use any of the following operators: 
( ) ^ * / + -
...
- No square root implementation

## How to use?
1) Clone the repository
2) Open the project in your IDE of choice (Visual Studio recommended)
3) Compile and run the program
4) Enter any mathematical expression using the following operators: ( ) ^ * / + -
5) Press ENTER when the equation is ready to be processed


DISCLAIMER: I do not use AI to work on my code.
